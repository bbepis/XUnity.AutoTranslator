...
{GameDirectory}/BepInEx/MonoMod.RuntimeDetour.dll  (OPTIONAL)
{GameDirectory}/BepInEx/MonoMod.Utils.dll          (OPTIONAL)
...
```
 ...
 3. OPTIONAL: If you notice errors in the console related to hooking, it may be because `MonoMod.RuntimeDetour.dll`, `MonoMod.Utils.dll` and `Mono.Cecil.dll` are not distributed in this package. You can obtain the latest version of these [here](https://github.com/MonoMod/MonoMod/releases) in the `net35` package.
...
```
 ...
 3. OPTIONAL: If you notice errors in the console related to hooking, it may be because `MonoMod.RuntimeDetour.dll`, `MonoMod.Utils.dll` and `Mono.Cecil.dll` distributed in BepInEx 5.0-RC1 are outdated. You can obtain the latest version of these [here](https://github.com/MonoMod/MonoMod/releases) in the `net35` package.
...
PatternFile=Translation\{GameExeName}\_SplitterPatterns.{lang}.txt
```
